...
<?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("update tb_buku set id='$Id', judul=' $judul', pengarang='$pengarang', penerbit='$penerbit', tahun_terbit=' $tahun', isbn='$isbn', jumlah_buku='$jumlah', lokasi='$lokasi', tgl_input='$tanggal' where id='$id'");
